...
public class RemoveStudent implements ActionListener{
	...
	RemoveStudent(){
		...
		frame.setTitle("移除學生");		//sets title of frame 
        ...
        remove.setBounds(185,118, 80, 23);
		...
		if(e.getSource() == remove) {
	        ...
	        if(check == 0) {
	        	try {
		            ...
		            if(delete == 1) {
		            	String sqlRemove="delete from `"+ TestGroupManage.Subject +"` where `studentnumber` = '" + inStudentNumber + "';";
